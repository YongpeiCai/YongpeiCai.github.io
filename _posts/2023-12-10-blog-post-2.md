...
where PV is the loan amount ($600,000 $\times$ (1-20%) = $480,000), C is the fixed mortgage payment (unknown), r is the effective annual rate (in this case, 5.06%), and T is the number of year (30 years).
